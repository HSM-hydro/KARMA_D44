...
##
## This script was developed within the KARMA project, which aims to achieve better
## karst groundwater management across the scale of the Mediterranean area.
##
## ---------------------------
##
## Notes:
